...
//define('YAAMP_DBUSER', 'glyoukandroid');
//define('YAAMP_DBPASSWORD', 'sqlGlyoukPa55');

define('YAAMP_DBHOST', 'localhost');
define('YAAMP_DBNAME', 'yiimpfrontend');
define('YAAMP_DBUSER', 'panel');
define('YAAMP_DBPASSWORD', 'AVtziSYqNAZbCdAxvxr2mCkWcZZTMwuD');
...
define('YAAMP_BTCADDRESS', '1Htx9jK8XEKmfMXpFSXfM255ugNLsHRDBp');
define('YAAMP_SITE_URL', 'onminer.net');//35.198.88.238
define('YAAMP_STRATUM_URL', YAAMP_SITE_URL); // change if your stratum server is on a different host
define('YAAMP_SITE_NAME', 'Onminer');
define('YAAMP_ADMIN_EMAIL', 'onminerpool@gmail.com');
...
define('EXCH_CRYPTOPIA_KEY', 'cc9e54b8cdbc435f8d4163b60699b980');
