...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-119120016-1"></script>
<script>
window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-119120016-1');
</script>
...
<meta name="description" content="Pool for alternative crypto currencies">
<meta name="keywords" content="onminer,crypto,crypt,anonymous,mining,pool,maxcoin,bitcoin,altcoin,auto,switch,exchange,profit,decred,scrypt,x11,x13,x14,x15,lbry,lyra2re,neoscrypt,sha256,quark,skein2">
...
function showPageHeader()
{
	...
	if(controller()->admin)
	{
        ...
        echo "<span><a href='https://crypt0.zone/calculator/' target='_blank'>Crypt0.Zone</a></span>";
        echo "&nbsp;";

        echo "<span><a href='https://www.crypto-coinz.net/crypto-calculator/' target='_blank'>Crypto-coinZ</a></span>";
        echo "&nbsp;";

        echo "<span><a href='https://play.google.com/store/apps/details?id=kg.stark.jarvis' target='_blank'>Monitor App</a></span>";
        echo "&nbsp;";
	...
	echo '<span style="font-size: .8em;">Next Payout: '.$nextpayment.'</span></span>';
