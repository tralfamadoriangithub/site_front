...
<div class="main-left-title">ONMINER MINING POOL</div>
<div class="main-left-inner" style="min-height: 270px;">
<img src="/onminer_logo.png" heigth="300" style="float: left;margin: 5px 20px;" width="300">
...
<!--li><strong>Lowest fees now</strong></li-->
...
<!--<li><b>IRC</b> - <a href='http://webchat.freenode.net/?channels=#yiimp' target=_blank >http://webchat.freenode.net/?channels=#yiimp</a></li>-->
    ...
    <li>
        <a href="https://t.me/onminerpool" class="link-center-aligned" target="_blank" style="display: flex;align-items: center;">
            <img src="/images/telegram-logo.svg" width="60" height="60"/>
            <span style="margin-left: 10px;font-size: 2em;">OnMinerPool</span>
        </a>
    </li>
...
<a class="twitter-timeline" href="https://twitter.com/onminerpool" data-chrome="transparent" width="500px" height="550px" data-tweet-limit="5" data-aria-polite="polite">Tweets about #OnMinerPool</a>
...
<br><br><br><br><br><br><br><br><br><br>
            ...
            <div id='partners_links'>
                <div class='main-left-box'>
                    <div class='main-left-title'>Partners</div>
                    <div class='main-left-inner'>
                        <div class="partner_link" style="padding: 7px;text-align: center;">
                            <a href="https://www.miningrigrentals.com/?ref=71722" target="_blank">
                                <img src="https://www.miningrigrentals.com/images/homelogo.png" border="0"
                                     class="image_link"/>
                            </a>
                        </div>
                        <div class="partner_link" style="padding: 7px;text-align: center;">
                            <a href="https://hiveos.farm/?ref=14601" target="_blank">
                                <img src="https://hiveos.farm/assets/img/hiveos-w.svg" class="image_link" style="width: 355px;background: #4b4b4b;padding: 10px;" border="0">
                            </a>
                       </div>
                    </div>
                </div>
